...
ROOT_URLCONF = 'SocioEconomicProblems.urls'
...
WSGI_APPLICATION = 'SocioEconomicProblems.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = env("CLOUDFLARE_R2_BUCKET")
AWS_S3_ENDPOINT_URL = f"https://{CLOUDFLARE_ACCOUNT_ID}.r2.cloudflarestorage.com"
AWS_S3_CUSTOM_DOMAIN = env("CLOUDFLARE_R2_PUBLIC_URL").replace("https://", "")
